...
export function InfoPanel({ isDarkMode = false }: InfoPanelProps) {
    ...
    return (
        <div className="w-screen h-screen flex items-start justify-start p-4">
            ...
            {isShown && (
                <div className={clsx("absolute mt-12 ml-8 w-fit left-20", {"bg-white text-slate-900": isDarkMode, "bg-slate-900 text-white": !isDarkMode}, "text-left rounded-xl py-8 px-8")}>
